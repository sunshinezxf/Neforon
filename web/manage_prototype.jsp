...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="${path.concat('/material/css/amazeui.min.css')}"/>
    <link rel="stylesheet" type="text/css" media="screen" href="${path.concat('/material/css/admin.css')}"/>
    <title>管理员页面</title>
</head>
<body>
...
<footer>
    <hr>
    <p class="am-padding-left">&copy; sunshinezxf@me.com</p>
</footer>

<script src="${path.concat('/material/js/jquery.min.js')}"></script>
<script src="${path.concat('/material/js/amazeui.min.js')}"></script>
<script src="${path.concat('/material/js/app.js')}"></script>
</body>
</html>
